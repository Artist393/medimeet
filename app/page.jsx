        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-muted-foreground text-lg text-gray-400 md:text-xl max-w-md">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="bg-emerald-600 text-white border-emerald-100/30 hover:bg-muted/80"
                >
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto text-gray-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <CardContent>
                  <p className="text-muted-foreground text-gray-400">{feature.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>

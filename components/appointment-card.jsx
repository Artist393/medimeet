...
export function AppointmentCard({ appointment, userRole, refetchAppointments }) {
  ...
  const handleMarkCompleted = async () => {
    ...
    if (new Date() < new Date(appointment.endTime)) {
      alert("Cannot mark as completed before appointment ends.");
      return;
    }
  ...
  return (
    <>
      ...
      {/* Dialog content preserved (excluding video section) */}
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4 py-4">
            {/* Other party, time, status, description... */}
            {/* ...code identical to yours, just removed the Video section */}
